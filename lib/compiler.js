...
Compiler.prototype = {
  ...
  compile: function () {
    recast.types.defineMethod('at', at)
    ...
    recast.types.defineMethod('at', a)
    function at (_loc) {
  ...
  generate: function () {
    ...
    var fn = b.functionDeclaration(b.identifier(this.options.sourceFileName).at(_loc), this.fn_arguments, b.blockStatement(body).at(_loc), false, false).at(_loc)
